...
console.log('VITE_DB_HOST:', process.env.VITE_DB_HOST ? '✓ Set' : '✗ Not set');
console.log('VITE_DB_USER:', process.env.VITE_DB_USER ? '✓ Set' : '✗ Not set');
console.log('VITE_DB_PASSWORD:', process.env.VITE_DB_PASSWORD ? '✓ Set' : '✗ Not set');
console.log('VITE_DB_NAME:', process.env.VITE_DB_NAME ? '✓ Set' : '✗ Not set');
console.log('VITE_DB_PORT:', process.env.VITE_DB_PORT ? '✓ Set' : '✗ Not set');
